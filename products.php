...
<link rel="shortcut icon" href="img/icon.png" />
 ...
 <style>
#pageshare {position:fixed; bottom:20%; right:50px; float:center; border: 3px solid black; border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;background-color:#eff3fa;padding:0 0 20px
0;z-index:10;}
      ...
      <ul>
        ...
        <li>
          <div class="item">
            ...
            <img src="css/images/9.png" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/10.png" alt="" /> </div>
        </li>
        <li>
          <div class="item">
            <div class="text">
            ...
            <img src="css/images/11.png" alt="" /> </div>
        </li>
